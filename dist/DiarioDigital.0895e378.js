...
module.bundle.HMR_BUNDLE_ID = "062e60410895e378";
"use strict";
...
async function mostrarHistorico() {
    ...
    try {
        const diarios = await (0, _supabaseService.SupabaseService).listarDiarios();
        historicoContainer.innerHTML = '';
        if (diarios.length === 0) {
            historicoContainer.innerHTML = "<p>Nenhum di\xe1rio registrado ainda.</p>";
            return;
        }
